...
function handleSubmit() {
  ...
  const orgUrl = document.getElementById("org_url").value;
  const countries = document.getElementById("countries").value;

 
 

  const orgLogo = document.getElementById("org_logo").value;
...
//  console.log(user_id)
  ...
  fetch(`https://team-org-backend.onrender.com/create-organization/${user_id}`, {
    method: 'POST',
    headers: {
    ...
    .then(data => {
     ...
     localStorage.setItem('org_id',org_id)
      ...
      window.location.href = "./inviteUser.html";
    })
    .catch(error => {
