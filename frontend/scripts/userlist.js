...
function renderUserCards(users) {
    ...
    users.forEach(user => {
        ...
        userdetail.classList.add('flex','mt-3','cursor-pointer','hover:bg-white','hover:shadow-md','py-0.5','px-1','rounded-sm' );
        ...
        userdetail.addEventListener('click', () => {
            ...
            window.location.href = "./userprofiles.html"
        });
...
function filterUsers() {
    const searchValue = document.getElementById('default_search').value.toLowerCase();
...
document.getElementById('default_search').addEventListener('input', filterUsers);
